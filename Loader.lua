...
local function validatePartBody(label, body)
    if body:find("game:BindToClose") or body:find("game%.BindToClose") then
        setStatus(label .. " ESKI SURUM! GitHub'a v" .. MIN_VERSION .. " yukle. (BindToClose hatasi)", true)
        return false
    end
